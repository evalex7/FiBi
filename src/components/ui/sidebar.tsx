    ...
    if (isMobile) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile}>
            <SheetContent side={side} className="w-full max-w-[280px] p-0 flex flex-col">
                {children}
            </SheetContent>
        </Sheet>
      )
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          hidden={(state !== "collapsed" && !isMobile) || (isMobile === null)}
          {...tooltip}
        />
      </Tooltip>
    )
