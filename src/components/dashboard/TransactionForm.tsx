...
export default function TransactionForm({
  ...
  const categoryTypeMap: Record<Transaction['type'], TransactionTypeGroup> = {
    income: 'income',
    expense: 'expense',
    credit_limit: 'credit',
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isEditMode && transaction) {
      ...
      toast({ title: 'Успіх!', description: `Вашу ${isCopy ? 'скопійовану ' : ''}транзакцію було додано.` });
    }
        ...
        {typeGroup === 'credit' && (
          <div className="grid gap-2">
            ...
            <Select
              required
              value={type}
              onValueChange={(value: Transaction['type']) => setType(value)}
              disabled
            >
              <SelectTrigger>
